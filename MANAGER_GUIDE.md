...
1. Open `Dashboard` for a quick summary.
2. Open `Reports` for more details.
3. Use filters like Today, Last 7 Days, This Month, or This Year.
...
2. Filter by date.
3. Open a sale to see the receipt details.
